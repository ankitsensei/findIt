...
const LostIt = () => {
  ...
  const mapMarkers = lostData
    ...
    .map((item) => ({
      ...
      title: item.name,
      popupHtml: `<a href="/lostit/${item.id}" style="font-weight:600;color:#18181b;text-decoration:none">${item.name}</a><br/><span style="font-size:12px;color:#71717a">${item.location}</span>`,
    }));
        ...
        <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm md:text-base text-zinc-500">
              Browse recently reported lost items and help reunite them.
            </p>
          </div>
